...
CFLAGS = -Wall -fPIC -c -g -O3 -I ../am335x_pru_package/pru_sw/app_loader/include
CXXFLAGS = -fPIC -c -Wall -g -O3  -I ../am335x_pru_package/pru_sw/app_loader/include -I./src/ -I ../moslibs/
